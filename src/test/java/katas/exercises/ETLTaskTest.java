...
public class ETLTaskTest {
    ...
    public void testETLProcess() throws Exception {
        ...
        try (Connection targetConn = DriverManager.getConnection("jdbc:sqlite:" + TARGET_DB);
            ...
            assertEquals("for users aged 30 to 60", rs.getString("age_group"));
            assertEquals(23, rs.getInt("years_registered")); // Based on the current year
            ...
            assertEquals("for users aged less than 30", rs.getString("age_group"));
            assertEquals(7, rs.getInt("years_registered"));
            ...
            assertEquals("for users aged over 60", rs.getString("age_group"));
            assertEquals(53, rs.getInt("years_registered"));
